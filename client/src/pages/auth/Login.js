        ...
        <>
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-md-4 mb-3">
                            <div className="card">
                                ...
                                />
                                <div className="card-body">
                                    <h5 style={{ textAlign: 'center' }}>Safi Ur Rehman</h5>
                                    <p className="card-text" style={{ textAlign: 'center' }}>Frontend Developer</p>
                                    <ul className="list-unstyled">
                                ...
                                <div className="card-footer text-center">
                                    <a href="mailto:safiqureshi531@gmail.com"><i className="fa-solid fa-envelope text-success me-3"></i></a>
                                    <a href="https://github.com/safiQureshi531"><i className="fa-brands fa-github text-success me-3"></i></a>
                                    <a href="https://www.linkedin.com/in/safi-qureshi-b2345b277/"><i className="fa-brands fa-linkedin text-success me-3"></i></a>
                                    <span>Phone: +91-9834467927</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer style={{ backgroundColor: "#333", color: "#fff", padding: "20px", textAlign: "center" }}>
                ...
                <p className="text-center" style={{ marginTop: '20px', color: 'white', fontSize: "18px" }}>
                    © 2024 | Designed and Developed by Prasam Jain and Safi Ur Rehman
                </p>
            </footer>
